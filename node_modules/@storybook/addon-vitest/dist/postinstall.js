import CJS_COMPAT_NODE_URL_9x1siro3z8i from 'node:url';
import CJS_COMPAT_NODE_PATH_9x1siro3z8i from 'node:path';
import CJS_COMPAT_NODE_MODULE_9x1siro3z8i from "node:module";

var __filename = CJS_COMPAT_NODE_URL_9x1siro3z8i.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_9x1siro3z8i.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_9x1siro3z8i.createRequire(import.meta.url);
...
import {
  any
} from "./_node-chunks/chunk-DQCWIDFG.js";
import {
  DOCUMENTATION_LINK
} from "./_node-chunks/chunk-JHMN5LZM.js";
import {
  require_dist
} from "./_node-chunks/chunk-27KXAFVR.js";
import {
  dirname,
  normalize,
  relative,
  resolve
} from "./_node-chunks/chunk-DY7BCJYQ.js";
import {
  require_compare,
  require_constants,
  require_debug,
  ...
  require_re,
  require_semver
} from "./_node-chunks/chunk-KGKVHIYF.js";
import {
  __commonJS,
  __toESM
} from "./_node-chunks/chunk-WYLUO6AB.js";
...
async function getTemplatePath(name) {
  switch (name) {
    case "vitest.config.template":
      return import("./_node-chunks/vitest.config-BLAXELQN.js");
    case "vitest.config.4.template":
      return import("./_node-chunks/vitest.config.4-ANUNRV6O.js");
    case "vitest.config.3.2.template":
      return import("./_node-chunks/vitest.config.3.2-24NWOXTJ.js");
    case "vitest.workspace.template":
      return import("./_node-chunks/vitest.workspace-VGD4JFVD.js");
    default:

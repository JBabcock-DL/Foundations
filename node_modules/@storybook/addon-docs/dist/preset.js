import CJS_COMPAT_NODE_URL_b9gy2t9yf1p from 'node:url';
import CJS_COMPAT_NODE_PATH_b9gy2t9yf1p from 'node:path';
import CJS_COMPAT_NODE_MODULE_b9gy2t9yf1p from "node:module";

var __filename = CJS_COMPAT_NODE_URL_b9gy2t9yf1p.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_b9gy2t9yf1p.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_b9gy2t9yf1p.createRequire(import.meta.url);

// ------------------------------------------------------------
// end of CJS compatibility banner, injected by Storybook's esbuild configuration
// ------------------------------------------------------------
import "./_node-chunks/chunk-D7NDXPSS.js";
...
async function webpack(webpackConfig = {}, options) {
  let { module = {} } = webpackConfig, { csfPluginOptions = {}, mdxPluginOptions = {} } = options, enrichCsf = await options.presets.apply("experimental_enrichCsf"), rehypeSlug = (await import("./_node-chunks/rehype-slug-U26YELH3.js")).default, rehypeExternalLinks = (await import("./_node-chunks/rehype-external-links-ZD5TIKWH.js")).default, mdxLoaderOptions = await options.presets.apply("mdxLoaderOptions", {
    ...mdxPluginOptions,
    mdxCompileOptions: {
...
var docs = (input = {}, options) => {
  ...
  let { plugins = [] } = config, { mdxPlugin } = await import("./_node-chunks/mdx-plugin-A6OWXPJ2.js"), { react, reactDom, mdx } = await getResolvedReact(options), packageDeduplicationPlugin = {

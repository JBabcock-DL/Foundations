...
import {
  compile
} from "./chunk-7ICQUY33.js";
import "./chunk-P2FV4DOC.js";
import "./chunk-QM5H6F3K.js";
import {
  __commonJS,
  __toESM
} from "./chunk-D7NDXPSS.js";
...
async function mdxPlugin(options) {
  let filter = createFilter(/\.mdx$/), { presets } = options, mdxPluginOptions = (await presets.apply("options", {}))?.mdxPluginOptions, rehypeSlug = (await import("./rehype-slug-U26YELH3.js")).default, rehypeExternalLinks = (await import("./rehype-external-links-ZD5TIKWH.js")).default;
  return {
